...
private	static	JButton		displayB		=	new	JButton("Display Question");
...
private static	MasterController	master;	
	...
	public	static	void	createThreads()
	{
		...
		fffP1	=	new Player(1,playerbtn1,answerBoard);
		fffP2	=	new Player(2,playerbtn2,answerBoard);
		fffP3	=	new Player(3,playerbtn3,answerBoard);
		fffP4	=	new Player(4,playerbtn4,answerBoard);
		fffP5	=	new Player(5,playerbtn5,answerBoard);
		fffP6	=	new Player(6,playerbtn6,answerBoard);
		fffP7	=	new Player(7,playerbtn7,answerBoard);
		fffP8	=	new Player(8,playerbtn8,answerBoard);
		fffP9	=	new Player(9,playerbtn9,answerBoard);
		fffP10	=	new Player(10,playerbtn10,answerBoard);
